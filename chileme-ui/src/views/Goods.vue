...
export default {
    data(){
        return{
            ...
            // 分类页签中的商品数据
            hotFoods:[
              {id:'ht001',goodname:'hot1',price:11,rata:3},
              {id:'ht002',goodname:'hot2',price:11.2,rata:3},
              {id:'ht003',goodname:'hot3',price:16,rata:3},
            ],
            coldFoods:[
              {id:'cd001',goodname:'cold1',price:7,rata:3},
              {id:'cd002',goodname:'cold2',price:8,rata:3},
              {id:'cd003',goodname:'cold3',price:9,rata:3},
            ],
            stampFoods:[
              {id:'st001',goodname:'rice',price:3,rata:3},
              {id:'st002',goodname:'noodles',price:6,rata:3},
            ],
            drinks:[
              {id:'dk001',goodname:'beer',price:5,rata:3},
              {id:'dk002',goodname:'soft',price:3.5,rata:3},
              {id:'dk003',goodname:'juice',price:10,rata:3},
            ],
            cartsList:[],    //购物车数据
            orderList:[
